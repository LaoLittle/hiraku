use self::Token::*;
use crate::lex::TokenKind as LxTkKind;
use crate::lex::{Base, Cursor, LiteralKind};
use crate::span::Span;
use std::str::FromStr;
...
pub struct TokenStream<'a> {
    source: &'a str,
    cursor: Cursor<'a>,
    lookahead: Option<crate::lex::Token>,
    prev_pos: usize,
    pos: usize,
}
...
impl<'a> Iterator for TokenStream<'a> {
    ...
    fn next(&mut self) -> Option<Self::Item> {
        ...
        if matches!(tk, Eof) { None } else { Some(tk) }
    }
}
...
impl<'a> TokenStream<'a> {
    ...
    pub fn peek_next(&mut self) -> crate::lex::Token {
    ...
    pub fn next_cursor_token(&mut self) -> crate::lex::Token {
